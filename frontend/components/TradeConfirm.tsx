...
export const TradeConfirm: FC<TradeConfirmProps> = ({
	...
	return (
		<section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:py-10">
			...
			<button
				onClick={onBack}
				className="absolute top-4 left-4 sm:top-20 sm:left-10 flex items-center gap-2 text-white/60 text-xs sm:text-sm hover:text-white transition-colors z-20"
			>
				<svg
					viewBox="0 0 24 24"
					fill="none"
				...
				<div className="card-glass">
					...
					<div className="warning-box mb-6">
						...
						<p className="warning-text">
							<strong>High leverage warning:</strong> {luckyNumber}x leverage
							means small price movements result in amplified gains or losses.
						</p>
					</div>
					...
					<span>Trade powered by flash.trade</span>
				</div>
			</div>
		</section>
	);
