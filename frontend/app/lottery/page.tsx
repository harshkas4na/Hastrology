...
const LotteryPage: FC = () => {
	...
	return (
		<section className="relative min-h-screen overflow-y-auto pb-40 md:pb-40">
			...
			<div className="relative z-10 w-full max-w-8xl mx-auto px-4 pt-15 md:pt-9 lg:pt-15">
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-8 lg:gap-1 items-start">
					<motion.div
